...
1. Clone the repository to your local machine:
   ```bash
   git clone [https://github.com/shikhardg24/Option-Pricing-Using-Fast-Fourier-Transform-FFT-.git](https://github.com/shikhardg24/Option-Pricing-Using-Fast-Fourier-Transform-FFT-.git)
